...
var runestoneJEI = AssemblyRecipe.create(function(c) {
  c.addItemOutput('output', <roots:runestone>);
})
.requireItem("input", (<contenttweaker:runestone_mix>))
.requireItem("input", (<ore:runes>))
.requireItem("input", (<rockhounding_chemistry:chemical_dusts:24>))
.requireDuration("duration", 400);
x.addJEIRecipe(runestoneJEI);
